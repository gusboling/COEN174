...
var engr_classes = [
   ...
   //also need to add 3 upper div ceon elective classes as well
];
...
var math_classes = [
   ...
   {class:"AMTH 108", units:4},
   {class:"MATH 53", units:4},{class:"CSCI 166", units:4},{class:"AMTH 118", units:4},/*all 3 classes fulfill same requirement*/
